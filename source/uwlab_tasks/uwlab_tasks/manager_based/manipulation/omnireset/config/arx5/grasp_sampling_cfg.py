...
"""OmniReset grasp sampling configuration for ARX5.

Adapted from ur5e_robotiq_2f85/grasp_sampling_cfg.py:
    - Robot: ARX5_GRIPPER (standalone gripper for grasp sampling)
    - Gripper base: link6 (URDF root link of standalone gripper)
"""
...
import uwlab_assets.robots.arx5 as arx5_robot
...
class GraspSamplingSceneCfg(InteractiveSceneCfg):
    ...
    robot = arx5_robot.ARX5_GRIPPER.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
class GraspSamplingEventCfg:
    ...
    grasp_sampling = EventTerm(
        ...
        params={
            ...
            "gripper_cfg": SceneEntityCfg("robot", body_names="link6"),
            "num_candidates": 1e6,
...
@configclass
class Arx5GraspSamplingCfg(ManagerBasedRLEnvCfg):
    ...
    actions: arx5_robot.Arx5BinaryGripperAction = arx5_robot.Arx5BinaryGripperAction()
